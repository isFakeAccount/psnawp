...
from psnawp_api.models.search.users_result_datatypes import SearchResultItemDict, UniversalDomainSearchResponseDict, UsersSearchResults
...
class UniversalUsersSearchIterator(PaginationIterator[SearchResultItemDict]):
    ...
    def fetch_next_page(self) -> Generator[SearchResultItemDict, None, None]:
        ...
        if self.next_cursor is not None:
            variables["nextCursor"] = self.next_cursor
        ...
        default_instance: UniversalDomainSearchResponseDict = {
        ...
        data: UsersSearchResults = response.get("data", {})
        universal_context_search = data.get("universalContextSearch", {})
        universal_domain_search = universal_context_search.get("results", [default_instance])[0]

        search_results: list[SearchResultItemDict] = universal_domain_search["searchResults"]
