...
class Client:
    ...
    def trophy_titles(self, limit: Optional[int] = None, offset: Optional[int] = 0) -> Iterator[TrophyTitle]:
        ...
        """
        return TrophyTitles(request_builder=self._request_builder, account_id="me").get_trophy_titles(limit=limit, offset=offset)
    ...
    def title_stats(self, limit: Optional[int] = None, offset: Optional[int] = 0) -> Iterator[TitleStats]:
        ...
        """
        return TitleStats.from_endpoint(request_builder=self._request_builder, account_id="me", limit=limit, offset=offset)
